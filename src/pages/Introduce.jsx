...
const Introduce = () => {
  ...
  const text1 = t("introduce.connect");
  const text2 = t("introduce.safeJourney");
        ...
        <div className="max-w-5xl mx-auto bg-white rounded-3xl shadow-lg p-10 text-center space-y-10">
          <div>
            <h3 className="text-2xl font-bold text-gray-900 mb-4">
              {t("services.parentsSolution.title")}
            </h3>
            <p className="text-gray-600 max-w-3xl mx-auto leading-relaxed">
              {t("services.parentsSolution.description")}
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-6 border-t border-orange-100">
            <div>
              ...
              <p className="text-gray-600 mt-1">{t("services.stats.routes")}</p>
            </div>
            <div>
              <p className="text-3xl font-bold text-orange-600">1K+</p>
              <p className="text-gray-600 mt-1">{t("services.stats.parents")}</p>
            </div>
            <div>
              <p className="text-3xl font-bold text-orange-600">98%</p>
              <p className="text-gray-600 mt-1">{t("services.stats.satisfaction")}</p>
            </div>
            <div>
              <p className="text-3xl font-bold text-orange-600">40+</p>
              <p className="text-gray-600 mt-1">{t("services.stats.drivers")}</p>
            </div>
          </div>
        </div>
      </section>
