...
//   const [notificationType, setNotificationType] = useState(null); // "denGan" | "tre"

//   const handleNotification = (type) => {
//     setNotificationType(type);
//     setShowNotification(true);
//     setShowOptions(false);
//     setTimeout(() => setShowNotification(false), 4000); // tự ẩn sau 4 giây
//   };
...
//         variant="parent"
//         menuItems={[
//           { label: t("Theo dõi vị trí"), link: "map", linkType: "section" },
//           {
...
//       {/* Khi bấm nút, hiển thị 2 lựa chọn */}
//       <AnimatePresence>
//         {showOptions && (
//           <motion.div
...
//             animate={{ opacity: 1, y: 0 }}
//             exit={{ opacity: 0, y: 50 }}
//             className={`fixed bottom-6 right-6 px-6 py-4 rounded-xl shadow-lg text-white ${
//               notificationType === "denGan" ? "bg-green-600" : "bg-red-600"
//             }`}
//           >
